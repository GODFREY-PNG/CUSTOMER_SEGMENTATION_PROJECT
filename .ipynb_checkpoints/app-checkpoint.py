...
st.markdown(
    "The app is built on K-Means clustering trained on **2,239 customers** "
...
That burns budget on people who will never spend and ignores the customers who actually drive revenue.All customers should not be given simmilar treatment as they are hidden groups that can be discovered and drive revenue
</p>
<p>
